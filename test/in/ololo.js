 ...
 * @namespace
 */
var Ololo = (function(DX, window, document, undefined) {
    'use strict';
    ...
    /**
     * Ololo value has changed
     *
     * @event Ololo#Ololo:changed
     */
    function fireChangeEvent(input) {
        event.trigger(input, Ololo.E_CHANGED);
    }
    /**
     * Ololo value was corrected
     *
     * @event Ololo#Ololo:corrected
     */
    function notifyOnCorrection(input) {
        ...
        event.trigger(input, Ololo.E_CORRECTED);
    }
     ...
     * @fires Ololo#Ololo:changed
     * @fires Ololo#Ololo:corrected
     */
    return function Ololo(input) {
        var elements = {},
        ...
        function initListeners() {
            ...
            input.addEventListener(Ololo.E_UPDATE_CONSTRAINTS, updateConstraints);
            input.addEventListener(Ololo.E_CHANGE_VALUE, changeValueExternally);
            input.addEventListener(Ololo.E_SET_CURSOR_POSITION, setCursorPosition);
        }
        /**
         * Sets cursor to specified position
         *
         * @event Ololo#Ololo:setucrsor
         ...
         */
        /**
         * Ololo constraints attributes were changed
         *
         * @event Ololo#Ololo:updateconstraints
         */
        ...
        /**
         * Ololo value was changed outside
         *
         * @event Ololo#Ololo:changevalue
         */
 ...
 * @memberof Ololo
 */
Ololo.E_CHANGED = 'Ololo:changed';
/** @constant
 * @type {string}
 * @default
 * @memberof Ololo
 */
Ololo.E_UPDATE_CONSTRAINTS = 'Ololo:updateconstraints';
/** @constant
 * @type {string}
 * @default
 * @memberof Ololo
 */
Ololo.E_CORRECTED = 'Ololo:corrected';
/** @constant
 * @type {string}
 * @default
 * @memberof Ololo
 */
Ololo.E_CHANGE_VALUE = 'Ololo:changevalue';
/** @constant
 * @type {string}
 * @default
 * @memberof Ololo
 */
Ololo.E_SET_CURSOR_POSITION = 'Ololo:setcursor';